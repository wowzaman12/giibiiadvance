...
{ \
    ...
    break; \
            ...
            case 0x44:
            {
                ...
                {
                    CPU.R[R_PC] -= 2; //Undefined Opcode #4-0
                    clocks -= 100;
                    break;
                }
            }
            case 0x45:
            {
                ...
                {
                    CPU.R[R_PC] -= 2; //Undefined Opcode #4-1
                    clocks -= 100;
                    break;
                }
            }
            case 0x46:
            {
                ...
                {
                    CPU.R[R_PC] -= 2; //Undefined Opcode #4-2
                    clocks -= 100;
                    break;
                }
            }
            case 0x47:
            {
                ...
                if(opcode & (BIT(7)|0x7))
                {
                    ...
                    CPU.R[R_PC] -= 2; //Undefined Opcode #4-4
                    clocks -= 100;
                    break;
                }
                else
...
{ \
    ...
    break; \
            ...
            {
                THUMB_UNDEFINED_INSTRUCTION(); //Unused Opcode #B
                break;
            }
            case 0xB4:
            {
            ...
            case 0xBE:
            {
                CPU.R[R_PC] -= 2; //Undefined Opcode #B
                clocks -= 100;
                break;
            }
            case 0xBF:
            {
                THUMB_UNDEFINED_INSTRUCTION(); //Undefined opcode #B
                break;
            }
...
{ \
    ...
    break; \
            ...
            {
                CPU.R[R_PC] -= 2; //Undefined Opcode #E
                clocks -= 100;
                break;
            }
