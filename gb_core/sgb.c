	{0x7000,0x0405,0x6c3b,0x756b,0x7000,0x0405,0x6c3b,0x756b,0x7000,0x0405,0x6c3b,0x756b,0x7000,0x0405,0x6c3b,0x756b},
	{0x0026,0x5100,0x749a,0x34f8,0x0026,0x5100,0x749a,0x34f8,0x0026,0x5100,0x749a,0x34f8,0x0026,0x5100,0x749a,0x34f8},
	{0x0954,0x0622,0x747a,0x7ff3,0x0954,0x0622,0x747a,0x7ff3,0x0954,0x0622,0x747a,0x7ff3,0x0954,0x0622,0x747a,0x7ff3}
};
*/
void SGB_RenderScreenBuffer(void)
{
	...
	if(mem->IO_Ports[BGP_REG-0xFF00] != 0xE4)
        DebugMessage("SGB data transfer, BGP != 0xE4");
	...
	for(y = 0; y < 18; y ++) for(x = 0; x < 20; x ++)
	{
		...
		if(tile_count > 255) return; //4 KB reached
	}
}
...
void SGB_Init(void)
{
    ...
    const u32 gbpalettes[4] = {GB_RGB(31,31,31),GB_RGB(21,21,21),GB_RGB(10,10,10),GB_RGB(0,0,0)};

	u32 i,j;
	for(i = 0; i < 4; i++) for(j = 0; j < 4; j++)
		SGBInfo.palette[i][j] = gbpalettes[j];
	for(i = 4; i < SGB_NUM_PALETTES; i++) for(j = 0; j < 16; j++)
		SGBInfo.palette[i][j] = gbpalettes[j>>2];

	for(i = 0; i < 512; i++) for(j = 0; j < 4; j++)
...
inline void SGB_Clock(int clocks)
{
...
{
	u32 i;
	for(i = 0; i < 8; i++) SGBInfo.palette[i][0] = rgb;
...
void SGB_ATTR_BLK(void)
{
	...
	for(i = 0; i < sets; i++)
	{
		...
		curbyte ++; if(curbyte == 16) { curbyte = 0; curpacket ++; }
	...
	//	DebugMessage("B:%d P:%d 1:%d,%d 2:%d,%d",curbyte,curpacket,x1,y1,x2,y2);

		if((ctrl & (1<<1)) || ((ctrl & 0x05) == 0x01) || ((ctrl & 0x05) == 0x04)) //Line
		{
			u32 pal;
		...
		if(ctrl & (1<<0)) //Inside
		{
			u32 pal = palettes & 3;
			u32 x,y;
			for(x = x1+1; x < x2; x ++) for(y = y1+1; y < y2; y ++)
			{
...
void SGB_ATTR_DIV(void)
{
	...
	if(SGBInfo.data[0][1] & (1<<6)) //Horizontal division
	{
		...
		{
			u32 pal = pal_line;
			if(y_ < y) pal = pal_down;
			else if(y_ > y) pal = pal_up;
	...
	else //Vertical division
	{
		...
		{
			u32 pal = pal_line;
			if(x_ < x) pal = pal_right;
			else if(x_ > x) pal = pal_left;
...
void SGB_PAL_SET(void)
{
	...
	if(attr & (1<<6)) SGBInfo.freeze_screen = 0;

	if(attr & (1<<7))
	{
		SGBInfo.curr_ATF = attr & 0x3F;
		if(SGBInfo.curr_ATF > 0x2C) SGBInfo.curr_ATF = 0x2C;
	}
}
...
void SGB_PAL_TRN(void)
{
	...
	u32 i,j;
	for(i = 0; i < 512; i++) for(j = 0; j < 8; j+=2)
...
void SGB_DATA_SND(void)
{
	...
	if(bank == 0)
	{
		if(address > 0x1FFF)
		{
			DebugMessage("SGB DATA_SND warning - %04xh bank 0, %d Bytes",
				SGBInfo.data[0][1] | (SGBInfo.data[0][2]<<8), SGBInfo.data[0][4]);
			return;
		}

		if(SGBInfo.sgb_bank0_ram == NULL) SGBInfo.sgb_bank0_ram = malloc(0x2000);
	...
	{
		DebugMessage("SGB DATA_SND warning - Wrote to bank %02xh",SGBInfo.data[0][3]);
		return;
	}
}
...
{
	DebugMessage("SGB DATA_TRN warning - Wrote to %04x, bank %02xh",
...
void SGB_CHR_TRN(void)
{
	...
	u32 * dest = SGBInfo.tile_data + ( (SGBInfo.data[0][1] & (1<<0)) ? 0x1000 : 0 );
...
void SGB_PCT_TRN(void)
{
	...
	u32 i;
	for(i = 0; i < 0x800; i+=2)
		dest[i>>1] = (u32)sgb_screenbuffer[i] | ((u32)sgb_screenbuffer[i+1]<<8);

	for(i = 0x800; i < 0x880; i+=2)
	{
		u32 pal = ((i & 0xFF) >> 5) + 4;
		u32 color = (i >> 1) & 0xF;
		SGBInfo.palette[pal][color] = (u32)sgb_screenbuffer[i] | ((u32)sgb_screenbuffer[i+1]<<8);
	}
...
void SGB_ATTR_TRN(void)
{
	...
	u32 i,j;
	for(i = 0; i < 0x2D; i++) for(j = 0; j < 20 * 18; j+=4)
	{
		SGBInfo.ATF_list[i][j]   = (sgb_screenbuffer[(i*18*5)+(j/4)] >> 6) & 0x3;
		SGBInfo.ATF_list[i][j+1] = (sgb_screenbuffer[(i*18*5)+(j/4)] >> 4) & 0x3;
		SGBInfo.ATF_list[i][j+2] = (sgb_screenbuffer[(i*18*5)+(j/4)] >> 2) & 0x3;
		SGBInfo.ATF_list[i][j+3] =  sgb_screenbuffer[(i*18*5)+(j/4)] & 0x3;
	}
}
...
void SGB_OBJ_TRN(void)
{
	...
	{
		DebugMessage("SGB OBJ_TRN warning - OBJ mode not emulated.");
	}
...
{
	//DebugMessage("SGB Command: %02x",SGBInfo.data[0][0] >> 3);
	...
	switch(SGBInfo.data[0][0] >> 3)
	{
		...
		case 0x07: //ATTR_CHR
			...
			return;
		case 0x08: //SOUND
		//	DebugMessage("SGB SOUND command - Not emulated");
			return;
		case 0x09: //SOU_TRN
		//	DebugMessage("SGB SOU_TRN command - Not emulated");
			return;
		case 0x0A: //PAL_SET
			SGB_PAL_SET();
			return;
		...
		case 0x0E: //ICON_EN
			...
			{
				DebugMessage("SGB ICON_EN command - Default palettes\nNot emulated");
				u32 i,j;
				for(i = 0; i < 4; i++) for(j = 0; j < 4; j++)
			...
			{
				//DebugMessage("SGB ICON_EN command - Set up screen?");
			}
			if(SGBInfo.data[0][1] & (1<<2))
			{
				SGBInfo.disable_sgb = 1;
				DebugMessage("SGB ICON_EN command - SGB disabled!");
			}
			return;
		case 0x0F: //DATA_SND
			SGB_DATA_SND();
		...
		case 0x11: //MLT_REG
			...
			return;
		case 0x12: //JUMP
			DebugMessage("SGB JUMP command - Not emulated");
			return;
		case 0x13: //CHR_TRN
			SGB_CHR_TRN();
			return;
		...
		case 0x15: //ATTR_TRN
			...
			return;
		case 0x16: //ATTR_SET
			if(SGBInfo.data[0][1] & (1<<6)) SGBInfo.freeze_screen = 0;
        ...
        case 0x1E: //BIOS_1 (?)
        case 0x1F: //BIOS_2 (?)
            //SGB rom sends first a 1Eh command, then a 1Fh command. Both are 1 packet long and
	...
	DebugMessage("Unknown command: %02x, Packets: %02x",SGBInfo.data[0][0] >> 3, SGBInfo.data[0][0]&0x07);
	u32 i;
	for(i = 0; i < (SGBInfo.data[0][0]&0x07);i++)
    {
        DebugMessage("%02x%02x %02x%02x %02x%02x %02x%02x %02x%02x %02x%02x %02x%02x %02x%02x",
        SGBInfo.data[i][0],SGBInfo.data[i][1],SGBInfo.data[i][2],SGBInfo.data[i][3],
...
inline int SGB_MultiplayerIsEnabled(void)
{
...
void SGB_WriteP1(u32 value)
{
	...
	if(SGBInfo.sending == 0)
	{
		if(SGBInfo.multiplayer != 0)
		{
			...
			else if(p14) SGBInfo.read_joypad |= 1<<4;
			else if(p15) SGBInfo.read_joypad |= 1<<5;
		}

		if((p14 | p15) == 0)
		{
			if(SGBInfo.delay > 0) return;
            //Clear everything
			SGBInfo.sending = 1;
			SGBInfo.currbit = 0;
			SGBInfo.currbyte = 0;
			...
			u32 i,j;
			for(i = 0; i < SGB_MAX_PACKETS; i++)
				for(j = 0; j < SGB_BYTES_PER_PACKET; j++)
					SGBInfo.data[i][j] = 0;
	...
	//	if(SGBInfo.delay > 0) return;
		...
		if(SGBInfo.currbyte == SGB_BYTES_PER_PACKET)
		{
			...
			{
				SGBInfo.sending = 0;
			//	DebugMessage("Received SGB packet.");
				...
				{
					//OK, EXECUTE DATA...
				//	DebugMessage("SGB packet completed!");
					SGB_ExecuteCommand();
				//	SGBInfo.delay = SGB_PACKET_DELAY;
				}
			//	else SGBInfo.delay = SGB_PACKET_DELAY;
			...
			else
			{
				SGBInfo.sending = 0;
				//Corrupted data...
				DebugMessage("Corrupted SGB packet.");
				return;
			}
		}
		...
		if((p14^p15) == 0) //If both are 1 or 0...
		{
			SGBInfo.sending = 0;
			//Corrupted data...?
			DebugMessage("SGB warning - Unexpected operation. Corrupted SGB packet?");
			return;
		}
		/*
		if(p14 == 0)
		{
			SGBInfo.data[SGBInfo.currpacket][SGBInfo.currbyte] &= ~(1<<currbit);
		}
		*/
		if(p15 == 0)
		{
			SGBInfo.data[SGBInfo.currpacket][SGBInfo.currbyte] |= 1<<SGBInfo.currbit;
		}
