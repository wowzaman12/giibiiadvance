...
int GB_CameraInit(int createwindow)
{
    ...
    return 1;
#else
    ErrorMessage("GiiBiiAdvance was compiled without camera features.");
    return 0;
#endif
}
...
{
    //DebugMessage("NO MAPPER WROTE - %02x to %04x",value,address);
    return;
}
...
void GB_MBC1Write(u32 address, u32 value)
{
    ...
    switch(address >> 12)
    {
        ...
        case 0xB:
            ...
            break;
        default:
            //DebugMessage("MBC1 WROTE - %02x to %04x",value,address);
            break;
    }
}
...
void GB_MBC3Write(u32 address, u32 value)
{
    ...
    switch(address >> 12)
    {
        ...
        case 0xB: //RTC Register 08-0C
            ...
            break;
        default:
            //DebugMessage("MBC3 WROTE- %02x to %04x",value,address);
            break;
    }
}
...
void GB_MBC6Write(u32 address, u32 value) // some things copied from MESS
{
    ...
    switch(address >> 12)
    {
        case 0x0:
            ...
            //DebugMessage("MBC6 WROTE - %02x to %04x",value,address);
            break;
        case 0x2:
            if(address == 0x27FF)
            {
            ...
            else if(address == 0x2800)
            {
                ...
                //else DebugMessage("MBC6 WROTE - %02x to %04x",value,address);
            }
            //else DebugMessage("MBC6 WROTE - %02x to %04x",value,address);
            break;
        case 0x3:
...
void GB_MBC7Write(u32 address, u32 value) // copied from VisualBoy Advance (and modified)
{
    ...
    switch(address >> 12)
    {
        ...
        case 0xB:
            ...
            break;
        default:
            //DebugMessage("MBC7 WROTE - %02x to %04x",value,address);
            break;
    }
}
...
void GB_MMM01Write(u32 address, u32 value)
{
    ...
    switch(address >> 12)
    {
        ...
        case 0x1:
            ...
            //DebugMessage("MMM01 WROTE - %02x to %04x",value,address);
            break;
            ...
            if(mem->mbc_mode == 1)
            {
                ...
                if(reg < 0x36)
                {
                    ...
                    if(reg == 0)
                    {
                        ...
                        //else DebugMessage("CAMERA WROTE - %02x to %04x",value,address);
                    }
                }
                //DebugMessage("CAMERA WROTE - %02x to %04x",value,address);
            }
...
{
    //DebugMessage("NO MAPPER READ - %04x",address);
    return 0xFF;
}
